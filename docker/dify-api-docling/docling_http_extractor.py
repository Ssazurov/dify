...
# Должен быть БОЛЬШЕ SUBPROCESS_TIMEOUT_S в docling-intake/main.py (сейчас 600s),
# иначе клиент уйдёт в fallback раньше, чем сервер успеет честно ответить 504.
